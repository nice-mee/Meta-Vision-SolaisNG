...
class UARTCommunicator:
    ...
    def __init__(
        ...
        # Initialize ROS
        rclpy.init()
        self.node = rclpy.create_node('uart_communicator')
        self.publisher = self.node.create_publisher(Float64MultiArray, 'yaw_pitch', 10)
    ...
    def try_parse_one(self, possible_packet):
        ...
        # Publish yaw and pitch
        msg = Float64MultiArray()
        msg.data = [cur_yaw, cur_pitch]
...
if __name__ == '__main__':
    ...
    rclpy.spin(uart.node)  # Add this line to keep the ROS node running
